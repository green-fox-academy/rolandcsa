...
public class Poker {
    public static void main(String[] args) {
        ...
        player3.getHand().add(new Card('6', 'S'));

        System.out.println(player1.printHand());
        System.out.println(player2.printHand());
        System.out.println(player3.printHand());
        System.out.println(player3.isFlush(player3));
        System.out.println(player3.isStraight(player3));
        System.out.println(player3.isStraightFlush(player3));
        System.out.println(player3.isFourOfAKind(player3));
    }
}
